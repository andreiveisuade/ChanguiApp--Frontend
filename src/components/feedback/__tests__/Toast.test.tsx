...
describe('Toast Component', () => {
  ...
  it('no renderiza nada cuando visible es false', () => {
    const { toJSON } = render(<Toast message="Hola" visible={false} onHide={mockOnHide} />);
  ...
  it('tiene accessibilityRole alert', () => {
    const { UNSAFE_queryAllByType } = render(<Toast message="Aviso" visible onHide={mockOnHide} />);
  ...
  it('renderiza con type success', () => {
    const { getByText } = render(<Toast message="OK" type="success" visible onHide={mockOnHide} />);
